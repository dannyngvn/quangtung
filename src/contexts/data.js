const data = [
...

    {
      ...
      "description": "Gọn nhẹ, tiện lợi, hữu dụng.",
      "category": "DỤNG CỤ YOGA",
      "shipping": true,
      "stars": 4,
      "review": 100,
...

{
  ...
  "description": "Dụng cụ hữu dụng khi bạn luyện tập.",
  "category": "DỤNG CỤ YOGA",
  "shipping": true,
  "stars": 4.1,
  "review": 100,
...

{
  ...
  "description": ["Là dòng thảm mới nhất của Lululemon năm 2023. Được thiết kế đặc biệt cho người tập Yoga.",
  "Bề mặt thấm hút độ ẩm tuyệt đối hỗ trợ bạn trong các hoạt động tiết nhiều mồ hôi.",
  "Đế cao su tự nhiên có nguồn gốc và được chứng nhận bởi FSC ™ mang đến cho bạn lớp đệm và độ bám chắc chắn để luyện tập ít mồ hôi."],
  "category": "THẢM YOGA",
  "shipping": true,
  "stars": 4.8,
  "review": 90,
...
}, 
{
  ...
  "description": ["thảm yoga Liforme là một lựa chọn tốt cho những người tập yoga muốn đảm bảo an toàn và hiệu quả khi tập luyện.",
  "Thảm Liforme là một loại thảm yoga được sản xuất bởi công ty Liforme.",
  "Thảm Liforme được thiết kế để đáp ứng nhu cầu của các tập yoga ở mọi cấp độ, với các tính năng vượt trội."],
  "category": "THẢM YOGA",
  "shipping": true,
  "stars": 4.6,
  "review": 90,
...
}, 
{
  ...
  "description": "Thoải mái, thoáng khí, hấp dẫn.",
  "category": "QUẦN ÁO TẬP",
  "shipping": true,
  "stars": 4.2,
  "review": 150,
...
}, 
{
  ...
  "description": "Thoải mái, thoáng khí, hấp dẫn, tự tin.",
  "category": "QUẦN ÁO TẬP",
  "shipping": true,
  "stars": 4.4,
  "review": 140,
